...
def consultar():
    ...
    for contacto in contactos:
        ...
        ventana.tblContactos.setItem(indiceControl,0,QTableWidgetItem(str(contacto[1])))
        ventana.tblContactos.setItem(indiceControl,0,QTableWidgetItem(str(contacto[2])))
        indiceControl+=1
...
ventana.tblContactos.setEditTriggers(QTableWidget.NoEditTiggers)
